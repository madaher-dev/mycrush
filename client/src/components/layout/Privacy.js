  ...
  return (
    <Fragment className={classes.main}>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Social Media Advertising Platform SL,
            Principe de vergara 97 Madrid Spain.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to MyCrush, accessible from{' '}
            <a
              href="http://www.mycrush.ws"
      ...
      <ul>
        ...
        <li>
          <p>Social Media Platform such as Facebook, Twitter and Instagram</p>
        </li>
        <li>
          <p>Usage Data</p>
        </li>
